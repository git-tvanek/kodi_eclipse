<?php
// source: C:\xampp\htdocs\kodi_eclipse/config/common.neon
// source: C:\xampp\htdocs\kodi_eclipse/config/doctrine.neon
// source: C:\xampp\htdocs\kodi_eclipse/config/services.neon
// source: array
...
class Container_de0e378f80 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'Psr\Cache\CacheItemPoolInterface' => [['nettrine.cache.adapter']],
		'Symfony\Component\Cache\Adapter\AdapterInterface' => [['nettrine.cache.adapter']],
		...
		'Doctrine\DBAL\Driver\Middleware' => [['nettrine.dbal.middleware.internal.tracy']],
		'Nettrine\DBAL\Middleware\TracyMiddleware' => [['nettrine.dbal.middleware.internal.tracy']],
		'Doctrine\Common\EventManager' => [['nettrine.dbal.eventManager']],
		'Nettrine\DBAL\Events\ContainerEventManager' => [['nettrine.dbal.eventManager']],
		...
		'App\Doctrine\EntityManagerDecorator' => [['nettrine.orm.entityManagerDecorator']],
		...
		'Doctrine\ORM\Tools\Console\EntityManagerProvider' => [['nettrine.orm.managerProvider']],
		'Nettrine\ORM\ManagerProvider' => [['nettrine.orm.managerProvider']],
		...
		'App\Repository\Interface\IAddonReviewRepository' => [
			0 => ['reviewRepository'],
			2 => [1 => 'reviewRepositoryAlias'],
		],
		'App\Repository\AddonReviewRepository' => [['reviewRepository']],
		'App\Repository\Interface\IScreenshotRepository' => [['screenshotRepository']],
		'App\Repository\ScreenshotRepository' => [['screenshotRepository']],
		...
		'App\Service\BaseService' => [
			['addonService', 'authorService', 'categoryService', 'reviewService', 'tagService', '032', '033', '034'],
		],
		'App\Service\IBaseService' => [
			0 => ['addonService', 'authorService', 'categoryService', 'reviewService', 'tagService', '032', '033', '034'],
			2 => [
				5 => 'addonServiceAlias',
				'authorServiceAlias',
		...
		'App\Service\IAddonReviewService' => [0 => ['reviewService'], 2 => [1 => 'reviewServiceAlias']],
		'App\Service\AddonReviewService' => [['reviewService']],
		...
		'App\Repository\Interface\IDownloadLogRepository' => [['027']],
		'App\Repository\DownloadLogRepository' => [['027']],
		'App\Repository\Interface\IPermissionRepository' => [['028']],
		'App\Repository\PermissionRepository' => [['028']],
		'App\Repository\Interface\IRoleRepository' => [['029']],
		'App\Repository\RoleRepository' => [['029']],
		'App\Repository\Interface\IUserRepository' => [['030']],
		'App\Repository\UserRepository' => [['030']],
		'App\Service\Interface\IAuthorizationService' => [['031']],
		'App\Service\AuthorizationService' => [['031']],
		'App\Service\IPermissionService' => [['032']],
		'App\Service\PermissionService' => [['032']],
		'App\Service\IRoleService' => [['033']],
		'App\Service\RoleService' => [['033']],
		'App\Service\IUserService' => [['034']],
		'App\Service\UserService' => [['034']],
	];
	...
	{
		return new App\Facade\AuthorizationFacade($this->getService('031'));
	}
	...
	{
		return new App\Forms\Factory\RolePermissionFormFactory($this->getService('032'));
	}
	...
	{
		return new App\Forms\Factory\UserRoleFormFactory($this->getService('033'));
	}


	public function createService027(): App\Repository\DownloadLogRepository
	{
		return new App\Repository\DownloadLogRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}


	public function createService028(): App\Repository\PermissionRepository
	{
		return new App\Repository\PermissionRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}


	public function createService029(): App\Repository\RoleRepository
	{
		return new App\Repository\RoleRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}


	public function createService030(): App\Repository\UserRepository
	{
		return new App\Repository\UserRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}


	public function createService031(): App\Service\AuthorizationService
	{
	...
	public function createService032(): App\Service\PermissionService
	{
		return new App\Service\PermissionService($this->getService('028'), $this->getService('017'));
	}


	public function createService033(): App\Service\RoleService
	{
		return new App\Service\RoleService($this->getService('029'), $this->getService('018'));
	}


	public function createService034(): App\Service\UserService
	{
		return new App\Service\UserService($this->getService('030'), $this->getService('020'));
	}
	...
	{
		return new App\Repository\AddonRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}
	...
	public function createServiceAddonService(): App\Service\AddonService
	{
		return new App\Service\AddonService(
			...
			'C:\xampp\htdocs\kodi_eclipse\app/../www/uploads',
		);
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\kodi_eclipse/temp/cache/nette.application/touch',
		));
	...
	{
		return new App\Repository\AuthorRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\kodi_eclipse/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\kodi_eclipse/temp/cache', $this->getService('cache.journal'));
	}
	...
	{
		return new App\Repository\CategoryRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_de0e378f80 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\kodi_eclipse/temp/cache/latte');
	...
	public function createServiceNettrine__cache__adapter(): Symfony\Component\Cache\Adapter\AdapterInterface
	{
	...
	{
		return Doctrine\Common\Cache\Psr6\DoctrineProvider::wrap($this->createServiceNettrine__cache__adapter());
	}
	...
	public function createServiceNettrine__dbal__configuration(): Doctrine\DBAL\Configuration
	{
		...
		$service->setMiddlewares([$this->getService('nettrine.dbal.middleware.internal.tracy')]);
		return $service;
	}
	...
	public function createServiceNettrine__dbal__eventManager(): Nettrine\DBAL\Events\ContainerEventManager
	{
		return new Nettrine\DBAL\Events\ContainerEventManager($this);
	}


	public function createServiceNettrine__dbal__middleware__internal__tracy(): Nettrine\DBAL\Middleware\TracyMiddleware
	{
		return new Nettrine\DBAL\Middleware\TracyMiddleware;
	}
	...
	{
		$service = new Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\xampp\htdocs\kodi_eclipse\app/Entity']);
	...
	public function createServiceNettrine__orm__configuration(): Doctrine\ORM\Configuration
	{
		...
		$service->setProxyDir('C:\xampp\htdocs\kodi_eclipse/temp/cache/doctrine/proxy');
		$service->setAutoGenerateProxyClasses(4);
		$service->setProxyNamespace('App\Proxies');
	...
	public function createServiceNettrine__orm__entityManagerDecorator(): App\Doctrine\EntityManagerDecorator
	{
		return new App\Doctrine\EntityManagerDecorator(Doctrine\ORM\EntityManager::create(
	...
	public function createServiceNettrine__orm__managerProvider(): Nettrine\ORM\ManagerProvider
	{
		return new Nettrine\ORM\ManagerProvider($this->getService('nettrine.orm.managerRegistry'));
	}
	...
	public function createServiceNettrine__orm__mappingDriver(): Doctrine\Persistence\Mapping\Driver\MappingDriverChain
	{
		...
		$service->addDriver($this->getService('nettrine.orm.attributes.attributeDriver'), 'App\Entity');
		return $service;
	}
	...
	public function createServiceReviewRepository(): App\Repository\AddonReviewRepository
	{
		return new App\Repository\AddonReviewRepository(
			$this->getService('nettrine.orm.entityManagerDecorator'),
			$this->getService('nettrine.cache.adapter'),
		);
	}


	public function createServiceReviewRepositoryAlias(): App\Repository\Interface\IAddonReviewRepository
	{
		return $this->getService('reviewRepository');
	}


	public function createServiceReviewService(): App\Service\AddonReviewService
	{
		return new App\Service\AddonReviewService($this->getService('reviewRepository'), $this->getService('reviewFactory'));
	}


	public function createServiceReviewServiceAlias(): App\Service\IAddonReviewService
	{
	...
	public function createServiceScreenshotRepository(): App\Repository\ScreenshotRepository
	{
		return new App\Repository\ScreenshotRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}
	...
	{
		return new App\Repository\TagRepository($this->getService('nettrine.orm.entityManagerDecorator'));
	}
	...
	public function initialize(): void
	{
		...
		(function () {
			...
			$this->getService('tracy.bar')->addPanel(new Nettrine\DBAL\Tracy\QueryPanel\QueryPanel($this->getService('nettrine.dbal.middleware.internal.tracy')));
		})();
	}
}
